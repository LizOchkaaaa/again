...
public class StudyGroupFactory {
    public StudyGroup createStudyGroup(Integer id , ArrayList<String> args) {
        ...
        StudyGroup newStudyGroup = new StudyGroup(id , name ,newPerson, semester, formOfEducation, coordinates, countStudent);

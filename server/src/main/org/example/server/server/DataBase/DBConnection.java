package main.org.example.server.server.DataBase;//package org.example.server.server.DataBase;

//import java.sql.Connection;
//import java.sql.DriverManager;
//import java.sql.SQLException;
//
//import static main.org.example.server.server.DataBase.MainDB.logger;
//
...
//            logger.info("DB driver not found!");
//            return null;
//        }
//
...
//            logger.info("Env variables DB_LOGIN or DB_PASSWORD are not matched!");
//            return null;
//        }
//        if (host == null) {
...
/**A class for establishing a connection to a database**/
public class DBConnection {

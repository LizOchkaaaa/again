...
public class DBInitializer {
    ...
    public void initialize() throws SQLException {
        ...
        statement.executeUpdate("CREATE TABLE IF NOT EXISTS s368864StudyGroup (" +
                ...
                "groupAdminHairColor varchar(6) NOT NULL CHECK(groupAdminHairColor='GREEN' OR " + "groupAdminHairColor='RED' OR " + "groupAdminHairColor='ORANGE' OR " + "groupAdminHairColor='WHITE')," + "author varchar(255)" + ")");
